...
/**
 * Accumulates gauge data points to produce an {@link AvailabilityBucketDataPoint}.
 *
...
final class AvailabilityDataPointCollector {
    ...
    AvailabilityBucketDataPoint toBucketPoint() {
        ...
        return new AvailabilityBucketDataPoint.Builder(bucketStart, to)
