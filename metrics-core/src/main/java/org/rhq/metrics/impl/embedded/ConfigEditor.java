...
import static org.rhq.metrics.impl.embedded.EmbeddedConstants.CASSANDRA_CONFIG;
import static org.rhq.metrics.impl.embedded.EmbeddedConstants.CASSANDRA_LISTEN_ADDRESS_DEFAULT;
import static org.rhq.metrics.impl.embedded.EmbeddedConstants.CASSANDRA_NATIVE_PORT_DEFAULT;
import static org.rhq.metrics.impl.embedded.EmbeddedConstants.CASSANDRA_YAML;
import static org.rhq.metrics.impl.embedded.EmbeddedConstants.JBOSS_DATA_DIR;
import static org.rhq.metrics.impl.embedded.EmbeddedConstants.RHQ_METRICS;
...
public class ConfigEditor {
    ...
    public void initEmbeddedConfiguration() throws Exception {
        ...
        File basedir = new File(System.getProperty(JBOSS_DATA_DIR, "./"), RHQ_METRICS);
        ...
        if (!yamlFile.exists()) {
            ...
            this.setClusterName(RHQ_METRICS);
