 ...
 */
package org.hawkular.metrics.restServlet.influx.query.parse.definition;

import static org.hawkular.metrics.restServlet.influx.query.parse.InfluxQueryParser.AggregatedColumnDefinitionContext;
import static org.hawkular.metrics.restServlet.influx.query.parse.InfluxQueryParser.AliasContext;
import static org.hawkular.metrics.restServlet.influx.query.parse.InfluxQueryParser.AndExpressionContext;
import static org.hawkular.metrics.restServlet.influx.query.parse.InfluxQueryParser.ColumnDefinitionContext;
import static org.hawkular.metrics.restServlet.influx.query.parse.InfluxQueryParser.ColumnDefinitionListContext;
import static org.hawkular.metrics.restServlet.influx.query.parse.InfluxQueryParser.DateOperandContext;
import static org.hawkular.metrics.restServlet.influx.query.parse.InfluxQueryParser.DoubleFunctionArgumentContext;
import static org.hawkular.metrics.restServlet.influx.query.parse.InfluxQueryParser.DoubleOperandContext;
import static org.hawkular.metrics.restServlet.influx.query.parse.InfluxQueryParser.EqExpressionContext;
import static org.hawkular.metrics.restServlet.influx.query.parse.InfluxQueryParser.FromClauseContext;
import static org.hawkular.metrics.restServlet.influx.query.parse.InfluxQueryParser.FunctionArgumentListContext;
import static org.hawkular.metrics.restServlet.influx.query.parse.InfluxQueryParser.FunctionCallContext;
import static org.hawkular.metrics.restServlet.influx.query.parse.InfluxQueryParser.FutureMomentOperandContext;
import static org.hawkular.metrics.restServlet.influx.query.parse.InfluxQueryParser.GroupByClauseContext;
import static org.hawkular.metrics.restServlet.influx.query.parse.InfluxQueryParser.GtExpressionContext;
import static org.hawkular.metrics.restServlet.influx.query.parse.InfluxQueryParser.IdNameContext;
import static org.hawkular.metrics.restServlet.influx.query.parse.InfluxQueryParser.IntegerFunctionArgumentContext;
import static org.hawkular.metrics.restServlet.influx.query.parse.InfluxQueryParser.IntegerOperandContext;
import static org.hawkular.metrics.restServlet.influx.query.parse.InfluxQueryParser.LimitClauseContext;
import static org.hawkular.metrics.restServlet.influx.query.parse.InfluxQueryParser.LtExpressionContext;
import static org.hawkular.metrics.restServlet.influx.query.parse.InfluxQueryParser.NameFunctionArgumentContext;
import static org.hawkular.metrics.restServlet.influx.query.parse.InfluxQueryParser.NameOperandContext;
import static org.hawkular.metrics.restServlet.influx.query.parse.InfluxQueryParser.NeqExpressionContext;
import static org.hawkular.metrics.restServlet.influx.query.parse.InfluxQueryParser.OrExpressionContext;
import static org.hawkular.metrics.restServlet.influx.query.parse.InfluxQueryParser.OrderAscContext;
import static org.hawkular.metrics.restServlet.influx.query.parse.InfluxQueryParser.PastMomentOperandContext;
import static org.hawkular.metrics.restServlet.influx.query.parse.InfluxQueryParser.PrefixContext;
import static org.hawkular.metrics.restServlet.influx.query.parse.InfluxQueryParser.PresentMomentOperandContext;
import static org.hawkular.metrics.restServlet.influx.query.parse.InfluxQueryParser.RawColumnDefinitionContext;
import static org.hawkular.metrics.restServlet.influx.query.parse.InfluxQueryParser.StringFunctionArgumentContext;
import static org.hawkular.metrics.restServlet.influx.query.parse.InfluxQueryParser.StringNameContext;
import static org.hawkular.metrics.restServlet.influx.query.parse.InfluxQueryParser.WhereClauseContext;
...
import org.hawkular.metrics.restServlet.influx.query.parse.InfluxQueryBaseListener;
